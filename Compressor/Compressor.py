...
class MP4GifConfig:
    ...
    webp_skip_preflight_on_exact_stats: bool = True
    webp_exact_stats_score_threshold: float = 0.001
    webp_continue_after_first_target: bool = True
    webp_target_mid_tolerance_ratio: float = 0.04
...
class WEBPConfig:
    ...
    webp_animated_exploratory_fast_enabled: bool = True
    ...
    webp_sample_probe_quality_alpha: float = 1.35
    webp_sample_probe_max_upward_factor: float = 1.20
    webp_sample_probe_max_upward_steps: int = 12
...
if __name__ == "__main__":
    ...
    print(
        f"Compressor {APP_VERSION} | MP4/MOV -> animated WEBP, "
